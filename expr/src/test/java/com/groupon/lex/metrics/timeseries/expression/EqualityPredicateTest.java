...
public class EqualityPredicateTest {
    ...
    public void testBoolBool() throws Exception {
        assertEquals(new TimeSeriesMetricDeltaSet(MetricValue.TRUE), create("true = true").apply(ctx));
        assertEquals(new TimeSeriesMetricDeltaSet(MetricValue.TRUE), create("false = false").apply(ctx));
        assertEquals(new TimeSeriesMetricDeltaSet(MetricValue.FALSE), create("false = true").apply(ctx));
        assertEquals(new TimeSeriesMetricDeltaSet(MetricValue.FALSE), create("true = false").apply(ctx));
    }

    @Test
    public void testBoolInt() throws Exception {
        assertEquals(new TimeSeriesMetricDeltaSet(MetricValue.TRUE), create("true = 1").apply(ctx));
        assertEquals(new TimeSeriesMetricDeltaSet(MetricValue.TRUE), create("false = 0").apply(ctx));
        assertEquals(new TimeSeriesMetricDeltaSet(MetricValue.FALSE), create("true = 17").apply(ctx));
        assertEquals(new TimeSeriesMetricDeltaSet(MetricValue.FALSE), create("false = 17").apply(ctx));
    }

    @Test
    public void testBoolFloat() throws Exception {
        assertEquals(new TimeSeriesMetricDeltaSet(MetricValue.TRUE), create("true = 1.0").apply(ctx));
        assertEquals(new TimeSeriesMetricDeltaSet(MetricValue.TRUE), create("false = 0.0").apply(ctx));
        assertEquals(new TimeSeriesMetricDeltaSet(MetricValue.FALSE), create("true = 17e1").apply(ctx));
        assertEquals(new TimeSeriesMetricDeltaSet(MetricValue.FALSE), create("false = 17e0").apply(ctx));
    }
    ...
    public void testIntBool() throws Exception {
        assertEquals(new TimeSeriesMetricDeltaSet(MetricValue.TRUE), create("1 = true").apply(ctx));
        assertEquals(new TimeSeriesMetricDeltaSet(MetricValue.TRUE), create("0 = false").apply(ctx));
        assertEquals(new TimeSeriesMetricDeltaSet(MetricValue.FALSE), create("17 = true").apply(ctx));
        assertEquals(new TimeSeriesMetricDeltaSet(MetricValue.FALSE), create("17 = false").apply(ctx));
    }

    @Test
    public void testIntInt() throws Exception {
        assertEquals(new TimeSeriesMetricDeltaSet(MetricValue.TRUE), create("1 = 1").apply(ctx));
        assertEquals(new TimeSeriesMetricDeltaSet(MetricValue.TRUE), create("0 = 0").apply(ctx));
        assertEquals(new TimeSeriesMetricDeltaSet(MetricValue.FALSE), create("17 = 16").apply(ctx));
    }

    @Test
    public void testIntFloat() throws Exception {
        assertEquals(new TimeSeriesMetricDeltaSet(MetricValue.TRUE), create("1 = 1.0").apply(ctx));
        assertEquals(new TimeSeriesMetricDeltaSet(MetricValue.TRUE), create("0 = 0.0").apply(ctx));
        assertEquals(new TimeSeriesMetricDeltaSet(MetricValue.FALSE), create("17 = 16.0").apply(ctx));
    }
    ...
    public void testFloatBool() throws Exception {
        assertEquals(new TimeSeriesMetricDeltaSet(MetricValue.TRUE), create("1.0 = true").apply(ctx));
        assertEquals(new TimeSeriesMetricDeltaSet(MetricValue.TRUE), create("0.0 = false").apply(ctx));
        assertEquals(new TimeSeriesMetricDeltaSet(MetricValue.FALSE), create("17.1 = true").apply(ctx));
        assertEquals(new TimeSeriesMetricDeltaSet(MetricValue.FALSE), create("17.2 = false").apply(ctx));
    }

    @Test
    public void testFloatInt() throws Exception {
        assertEquals(new TimeSeriesMetricDeltaSet(MetricValue.TRUE), create("1.0 = 1").apply(ctx));
        assertEquals(new TimeSeriesMetricDeltaSet(MetricValue.TRUE), create("0.0 = 0").apply(ctx));
        assertEquals(new TimeSeriesMetricDeltaSet(MetricValue.FALSE), create("16.1 = 16").apply(ctx));
    }

    @Test
    public void testFloatFloat() throws Exception {
        assertEquals(new TimeSeriesMetricDeltaSet(MetricValue.TRUE), create("1.0 = 1.0").apply(ctx));
        assertEquals(new TimeSeriesMetricDeltaSet(MetricValue.TRUE), create("0.0 = 0.0").apply(ctx));
        assertEquals(new TimeSeriesMetricDeltaSet(MetricValue.FALSE), create("16.1 = 16.0").apply(ctx));
    }
    ...
    public void testStringString() throws Exception {
        assertEquals(new TimeSeriesMetricDeltaSet(MetricValue.TRUE), create("\"foo\" = \"foo\"").apply(ctx));
        assertEquals(new TimeSeriesMetricDeltaSet(MetricValue.FALSE), create("\"foo\" = \"bar\"").apply(ctx));
    }
    ...
    public void testHistogramHistogram() throws Exception {
        assertEquals(new TimeSeriesMetricDeltaSet(MetricValue.TRUE), create("[0..3=3] = [0..1=1, 1..2=1, 2..3=1]").apply(ctx));
        assertEquals(new TimeSeriesMetricDeltaSet(MetricValue.FALSE), create("[] = [0..1=1]").apply(ctx));
    }

    private static EqualityPredicate create(String expr) throws TimeSeriesMetricExpression.ParseException {
        return (EqualityPredicate) TimeSeriesMetricExpression.valueOf(expr);
    }
}
