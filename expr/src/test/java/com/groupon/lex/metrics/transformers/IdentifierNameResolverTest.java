...
public class IdentifierNameResolverTest {
    ...
    public void setup() {
        ...
        tsv0 = new ImmutableTimeSeriesValue(group_name, EMPTY_MAP);
        final TimeSeriesCollection tsc0 = new SimpleTimeSeriesCollection(DateTime.now(DateTimeZone.UTC), singleton(tsv0));
        final TimeSeriesCollectionPair ts_data = new ImmutableTimeSeriesCollectionPair(Arrays.asList(tsc0));
